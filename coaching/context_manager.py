...
AUTHOR_REPLY_CTA_S = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔥 다음 한 걸음: 대표가 먼저 시간을 냅니다
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

작가님의 원고는 올해 저희가 만난 원고 중 위쪽에 속합니다.
솔직히 말씀드리면, 이런 원고는 놓치고 싶지 않습니다.

그래서 제가 먼저 시간을 비워두었습니다.
**대표 1:1 무료 상담 (15분)** — 제주/서울/비대면 모두 가능합니다.

👉 https://calendly.com/joyful4/goodbook

상담에서는:
  · 이 원고를 어떤 방향(기획출판·협업·자체)으로 낼지
  · 초판 몇 부를 어떤 독자에게 어떻게 팔지
  · 계약 조건과 출간 일정까지

숫자로 그려드립니다. 한 번 이야기 나눠보시죠.
"""

AUTHOR_REPLY_CTA_A = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⭐ 다음 한 걸음: 기획출판 가능성을 함께 점검
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

작가님의 원고는 **기획출판 후보군**에 들 수 있는 원고입니다.
몇 가지만 함께 다듬으면 충분히 상용화 가능합니다.

대표가 직접 원고를 다시 읽고,
출간 방향을 맞춤 제안하는 **15분 무료 상담**을 먼저 잡아주세요.

👉 https://calendly.com/joyful4/goodbook
    (제주/서울/비대면 모두 가능)

상담이 부담스러우시면 메일로만 상세 리포트 받으셔도 됩니다.
어느 쪽이든, 작가님 페이스에 맞춰 가겠습니다.
"""

AUTHOR_REPLY_CTA_B = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📚 다음 한 걸음: 기획 방향만 선명해지면
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

원고 잘 읽었습니다.
이야기의 뼈대와 작가님의 목소리는 분명히 느껴졌어요.
다만 **"누구에게, 어떤 약속을 주는 책인지"** — 이 한 줄만 더 선명해지면
원고의 체급이 한 단계 달라질 겁니다.

가장 권해드리는 건:
  · **무료 5일 부트캠프** — 주제·독자를 구체적으로 잡아봅니다.
    👉 https://jagabook.co.kr/bootcamp

부트캠프에서 방향이 잡히면, 그때 다시 원고를 보내주세요.
저희가 우선 검토해 드립니다.

(혹시 바로 1:1로 이야기 나누고 싶으시면 아래 링크로 시간 잡아주셔도 됩니다.)
    👉 https://calendly.com/joyful4/goodbook
"""
...
원고를 보내주신 그 용기, 먼저 감사드립니다.
쓰던 중 멈춘 원고를 세상에 꺼내는 건 결코 쉬운 일이 아니에요.

솔직한 의견을 드리면,
**지금 이 원고 그대로 책으로 내기엔** 조금 더 시간을 들이셔야 할 것 같습니다.
다만 이건 원고 자체가 부족해서가 아니라,
**책이라는 형태에 맞게 정리할 시간이 필요하다**는 뜻입니다.

무료로 받으실 수 있는 성장 경로:

  1️⃣ **100질문 PDF** — 책 쓰기 전에 정리해야 할 100가지
     · 스티비 구독 시 즉시 발송
     👉 https://stib.ee/cD9N

  2️⃣ **무료 5일 부트캠프** — 주제·독자·포지셔닝 재정비
     👉 https://jagabook.co.kr/bootcamp

다듬으신 후 다시 원고 보내주시면,
같은 사람이 한 번 더 읽어드리겠습니다. 약속드립니다.
"""


def _cta_by_grade(grade: str) -> str:
    if grade == "S":
        return AUTHOR_REPLY_CTA_S
    if grade == "A":
        return AUTHOR_REPLY_CTA_A
    if grade == "B":
